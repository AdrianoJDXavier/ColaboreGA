...
Route::get('/', 'ContratoController@venceContrato');
...
Route::get('listar pessoaF', 'TorController@listaTorPessoaFisica');
...
Route::get('removeparticipante/{id}', 'ParticipanteController@remove')->name('removeparticipante');

Route::get('criaTermo', 'TorController@cria');

Route::get('print-pdf/{id}', 'pdfController@printPDF')->name('print-pdf');